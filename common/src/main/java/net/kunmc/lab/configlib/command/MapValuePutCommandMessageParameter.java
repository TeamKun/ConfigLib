...
public class MapValuePutCommandMessageParameter<K, V> {
    ...
    public MapValuePutCommandMessageParameter(String entryName, CommandContext ctx, K key, V value) {
        this(entryName, ctx, key, value, ConfigCommandDescriptions.defaultProvider());
    }

    public MapValuePutCommandMessageParameter(String entryName,
                                              CommandContext ctx,
                                              K key,
                                              V value,
