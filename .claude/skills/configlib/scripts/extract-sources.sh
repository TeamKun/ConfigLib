...
BUKKIT_JAR=$(find ~/.gradle/caches/modules-2/files-2.1/com.github.TeamKun.ConfigLib \
...
COMMON_JAR=$(find ~/.gradle/caches/modules-2/files-2.1/com.github.TeamKun.ConfigLib \
