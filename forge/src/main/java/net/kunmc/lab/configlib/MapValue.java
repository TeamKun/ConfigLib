...
public abstract class MapValue<K, V, T extends MapValue<K, V, T>> extends Value<Map<K, V>, T> {
    ...
    protected boolean validateKeyForPut(String entryName, K k, CommandSource sender) {
        return true;
    }

    protected String invalidKeyMessageForPut(String entryName, K k, CommandSource sender) {
        return "";
    }

    protected boolean validateValueForPut(String entryName, V v, CommandSource sender) {
        return true;
    }

    protected String invalidValueMessageForPut(String entryName, V v, CommandSource sender) {
        return "";
    }
    ...
    protected boolean validateKeyForRemove(String entryName, K k, CommandSource sender) {
        return value.containsKey(k);
    }

    protected String invalidKeyMessageForRemove(String entryName, K k, CommandSource sender) {
