...
public class EnumValue<T extends Enum<T>> extends SingleValue<T, EnumValue<T>> {
    ...
    @Override
    protected boolean validateOnSet(String entryName, T newValue, CommandSender sender) {
        return true;
    }

    @Override
    protected String invalidValueMessage(String entryName, T newValue, CommandSender sender) {
